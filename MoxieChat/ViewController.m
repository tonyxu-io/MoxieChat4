...
//#define MOXTRASDK_UNIQUE_ID  @"audit-admin"
...
- (void)alertToLogin
{
                                 ...
                                 handler:^(UIAlertAction *action)
    {
        ...
        uniqueID = textField.text;
        NSLog(@"Unique ID Stored %@",uniqueID);
...
{
    __weak typeof(self) weakSelf = self;
    [[MXChatClient sharedInstance] linkWithUniqueId:uniqueID orgId:MOXTRASDK_ORG_ID clientId:MOXTRASDK_CLIENT_ID clientSecret:MOXTRASDK_CLIENT_SECRET baseDomain:MOXTRASDK_BASE_DOMAIN completionHandler:^(NSError * _Nullable error) {
